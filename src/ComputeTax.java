 ...
 * Program made to compute the tax on income based on filing status
 */
    ...
    public static void main(String[] args){
        ...
        if (status == 0){
            ...
            if (income <= 16700){
                ...
                tax = 16700 * 0.10 + (67900 - 16700) *0.15 + (13750 - 67900) * 0.25 +
            ...
            if (income <= 8350){
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (income - 33930) * 0.25;
            }else if (income <= 104425){
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33930) * 0.25 +
                        (income - 68525) * 0.28;
